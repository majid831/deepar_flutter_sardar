    ...
    public void onSurfaceRequested(@NonNull SurfaceRequest request) {
        ...
        if(surfaceTexture == null) {
            ...
            surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() {
                @Override
                public void onFrameAvailable(SurfaceTexture __) {
                    if (stop) {
                        return;
                    }
        ...
        request.setTransformationInfoListener(ContextCompat.getMainExecutor(context), new SurfaceRequest.TransformationInfoListener() {
            @Override
            public void onTransformationInfoUpdate(@NonNull SurfaceRequest.TransformationInfo transformationInfo) {
                orientation = transformationInfo.getRotationDegrees();
            }
        });

        request.provideSurface(surface, ContextCompat.getMainExecutor(context), new Consumer<SurfaceRequest.Result>() {
            @Override
